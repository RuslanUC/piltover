...
__text = "Choose a sticker set or send me the sticker you want to replace."
__text_no_sets = "You have no sets :("  # TODO: correct text


async def stickers_replacesticker_command(peer: Peer, _: MessageRef) -> MessageRef | None:
