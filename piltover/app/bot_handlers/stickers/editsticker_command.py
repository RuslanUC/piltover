...
__text = "Choose the sticker set you're interested in. Or just send me the sticker you want to edit."
__text_no_sets = "You have no sets :("  # TODO: correct text


async def stickers_editsticker_command(peer: Peer, _: Message) -> Message | None:
    ...
    await StickersBotUserState.update_or_create(user=peer.owner, defaults={
        "state": StickersBotState.EDITSTICKER_WAIT_PACK,
        "data": None,
