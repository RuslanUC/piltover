...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        ops.RunSQL("ALTER TABLE dialog ADD INDEX peer_id (peer_id)"),
        ops.RunSQL(f"ALTER TABLE dialog ADD CONSTRAINT {dialog_fk_name} FOREIGN KEY (peer_id) REFERENCES peer(id)"),
        ...
        ops.RunSQL("ALTER TABLE messagedraft ADD INDEX peer(peer_id)"),
        ops.RunSQL(f"ALTER TABLE messagedraft ADD CONSTRAINT {draft_fk_name} FOREIGN KEY (peer_id) REFERENCES peer(id)"),

        ops.RunSQL(f"ALTER TABLE readstate DROP FOREIGN KEY {readstate_fk_name}"),
        ops.RunSQL("ALTER TABLE readstate DROP INDEX peer_id"),
        ops.RunSQL("ALTER TABLE readstate ADD INDEX peer(peer_id)"),
        ops.RunSQL(f"ALTER TABLE readstate ADD CONSTRAINT {readstate_fk_name} FOREIGN KEY (peer_id) REFERENCES peer(id)"),
        ...
        ops.RunSQL("ALTER TABLE saveddialog ADD INDEX peer(peer_id)"),
        ops.RunSQL(f"ALTER TABLE saveddialog ADD CONSTRAINT {saveddialog_fk_name} FOREIGN KEY (peer_id) REFERENCES peer(id)"),
